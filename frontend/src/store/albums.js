...
export const CREATE_ALBUM_START = "albums/CREATE_ALBUM_START";
export const CREATE_ALBUM_SUCCESS = "albums/CREATE_ALBUM_SUCCESS";
export const CREATE_ALBUM_FAILURE = "albums/CREATE_ALBUM_FAILURE";

export const DELETE_ALBUM_START = "albums/DELETE_ALBUM_START";
export const DELETE_ALBUM_SUCCESS = "albums/DELETE_ALBUM_SUCCESS";
export const DELETE_ALBUM_FAILURE = "albums/DELETE_ALBUM_FAILURE";
